      ...
      children: [
        DatePickerOutlinedButton(
          ...
          text: _selectedFirstTermBeginingDate != null
              ? "Début du premier semestre : ${DateFormat("dd.MM.y").format(_selectedFirstTermBeginingDate)}"
        ...
        DatePickerOutlinedButton(
          ...
          text: _selectedSecondTermBeginingDate != null
              ? "Début du deuxième semestre : ${DateFormat("dd.MM.y").format(_selectedSecondTermBeginingDate)}"
        ...
        DatePickerOutlinedButton(
          ...
          text: _selectedSecondTermEndDate != null
              ? "Fin du deuxième semestre : ${DateFormat("dd.MM.y").format(_selectedSecondTermEndDate)}"
